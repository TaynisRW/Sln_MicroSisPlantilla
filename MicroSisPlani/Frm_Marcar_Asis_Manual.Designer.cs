namespace MicroSisPlani
{
    partial class Frm_Marcar_Asis_Manual
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lbl_hora.FlashStyle = paintStyle33;
			...
			this.Lbl_HoraEntrada.FlashStyle = paintStyle34;
			...
			this.lbl_Cont.FlashStyle = paintStyle35;
			...
			this.Lbl_Idperso.FlashStyle = paintStyle36;
			...
			this.lbl_Dni.FlashStyle = paintStyle37;
			...
			this.lbl_nombresocio.FlashStyle = paintStyle38;
			...
			this.lbl_totaltarde.FlashStyle = paintStyle39;
			...
			this.lbl_justifi.FlashStyle = paintStyle40;
